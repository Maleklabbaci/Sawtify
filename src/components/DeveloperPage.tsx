...
export const DeveloperPage: React.FC<{ balance: number }> = ({ balance }) => {
  ...
  return <div className="max-w-5xl mx-auto space-y-6">
    <div className="rounded-3xl bg-gradient-to-br from-slate-950 via-purple-950 to-purple-700 p-7 text-white shadow-xl">
      <div className="flex items-start justify-between gap-4"><div className="min-w-0"><div className="flex items-center gap-2 text-purple-200 text-xs font-bold uppercase tracking-widest"><Code2 className="h-4 w-4" /> Developer API <span className="rounded-full bg-white/15 px-2 py-0.5">BETA</span></div><h1 className="mt-3 text-2xl sm:text-3xl font-black break-words">Intègre Sawtify partout.</h1><p className="mt-2 max-w-2xl text-sm leading-6 text-purple-100">Utilise la synthèse vocale Sawtify dans tes chatbots, boîtes vocales, CRM et automatisations. La sortie est un WAV mono 24 kHz compatible avec les systèmes vocaux.</p></div><Terminal className="hidden sm:block h-14 w-14 shrink-0 text-purple-200/60" /></div>
